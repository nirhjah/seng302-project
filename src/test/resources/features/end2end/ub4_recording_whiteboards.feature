@recording_whiteboards

Feature: UB4 Recording Whiteboards

  Scenario: AC1 Users can save videos and screenshots to their file system and to the teams library of recordings and screenshots
