...
#
#  Scenario: AC1: Federation administrators are a special type of users and are the only one allowed to create or update competitions
#    Given I am a user of account type federation administrator and I am viewing a competition,
#    When I click on a ui element for updating a competition,
...
#      Given I am a user of account type federation administrator and I am on the create or update competition page and I input valid information for name, sport and grade level,
#      When I click create competition,
#      Then the competition is created and I am shown a ui element that display full details for the competition.
#
#      Scenario: AC2: A competition has a name, is for a given sport, and is for a certain grade level, e.g., U10 (under 10-year-old), masters, MAG level 3. All are compulsory fields.
#        Given I am a user of account type federation administrator and I am on the create or update  competition page and I input invalid information for one of name, sport or grade level,
#        When I click create/update competition,
#        Then the competition is not created/updated and I am shown an error message stating that the field contains invalid information
#
#  Scenario: AC2: A competition has a name, is for a given sport, and is for a certain grade level, e.g., U10 (under 10-year-old), masters, MAG level 3. All are compulsory fields.
#    Given I am a user of account type federation administrator and I am on the create or update competition page and don’t input information for one of name, sport or grade level,
#    When I click create/update competition,
...
#      When I select a user from a list of users in the system and I add that user to the competition and save my changes
#      Then that user is added to the competition
#
#
#  Scenario: AC4: A competition can include teams or individuals. For teams, a competition must include at least one team and all teams must be of the same grade level. For individuals, at least one person needs to be added to the competition.
#    Given I am a user of account type federation administrator
#    And I am viewing a designated page for a competition that I created
#    And I have selected competition type as team,
#    When I select a team from a list of teams in the system and I add that team to the competition and save my changes,
