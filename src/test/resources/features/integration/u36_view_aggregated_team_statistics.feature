...
#    And their dates and scores will also be displayed alongside it
#
#  Scenario: AC6: I can see the results of the 5 last activities with scores (I.e. friendlies and games), with their dates and scores.    Given I see the aggregated team statistics
